pipeline {
  ...
  stages {
    stage('CI Build and push snapshot') {
      ...
      steps {
        container('go') {
          dir('/home/jenkins/go/src/github.com/srikanthcone/srik-buildpack-test2') {
            checkout scm
          ...
          dir('/home/jenkins/go/src/github.com/srikanthcone/srik-buildpack-test2/charts/preview') {
            sh "make preview"
    ...
    stage('Promote to Environments') {
      ...
      steps {
        container('go') {
          dir('/home/jenkins/go/src/github.com/srikanthcone/srik-buildpack-test2/charts/srik-buildpack-test2') {
